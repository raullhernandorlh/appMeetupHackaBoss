  ...
  methods: {
    ...
    async registerPayment(){
      try{
        ...
        const response = await axios.post("http://localhost:8888/payments", {
        ...
        // Una vez realizamos el pago redirigimos a la pantalla de reservas de usuario

        this.$router.push({name:'OrganizerReservations'})
